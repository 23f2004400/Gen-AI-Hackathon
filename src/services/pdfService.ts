...
export class PDFService {
  static generateParentBrief(brief: ParentBrief): void {
    ...
    doc.text('PathSathi - Career Plan Summary', margin, yPosition);
    ...
    doc.text('Generated by PathSathi - AI Career Co-pilot', margin, yPosition);
    doc.text('For support: contact@pathsathi.in | 1800-XXX-XXXX', margin, yPosition + 8);
